...
public class DatabaseDataWorker {
    ...
    public void insertCourses(){
        ...
        insertCourse("java_lang","Java Fundamentals: The Core Platform");
    }
    ...
    public void insertSampleNotes(){
        ...
        insertNote("android_async", "Service defualt threads", "Did you know that by default an Android Service will tie up the UI thread");
        insertNote("android_async", "Long running operations", "Foreground Services can be tied to a notifiation icon");

        insertNote("java_lang", "Parameters", "Leverage variable-length parameter lists?");
        insertNote("java lang", "Anonymous classes", "Anonymous classes simplify implementing one-use types");

        insertNote("java_core", "Compiler options", "The -jar option isn't compatible with the -cp option");
        insertNote("java_core", "Serialisation", "Remember to include SerialVersionUID to assure version compatibility");
    }
    ...
    private void insertCourse(String courseId, String title) {
        ...
        long nweRowId = mDb.insert(NoteKeeperDatabaseContract.CourseInfoEntry.TABLE_NAME, null, values);
    }
}
